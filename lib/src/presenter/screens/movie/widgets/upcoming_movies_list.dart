...
class _UpcomingMoviesList extends StatefulWidget {
  ...
  @override
  State<_UpcomingMoviesList> createState() => UpcomingMoviesListState();
}

class UpcomingMoviesListState extends State<_UpcomingMoviesList> {
  ...
  void _onScroll() {
    ...
    if (isBottom) {
      movieBloc.add(const MoviesLoadByType(movieType: MovieType.upcoming));
    }
  }
