...
class _NowPlayingMoviesList extends StatefulWidget {
  const _NowPlayingMoviesList();

  @override
  State<_NowPlayingMoviesList> createState() => _NowPlayingMoviesListState();
}

class _NowPlayingMoviesListState extends State<_NowPlayingMoviesList> {
  ...
  void _onScroll() {
    ...
    if (isBottom) {
      movieBloc.add(const MoviesLoadByType(movieType: MovieType.nowPlaying));
    }
  }
