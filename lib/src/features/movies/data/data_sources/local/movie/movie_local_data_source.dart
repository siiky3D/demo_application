...
abstract class MovieLocalDataSource {
  ...
  /// Deletes the movie detail with the given [movieId] from the local
  /// data source.
  Future<void> deleteMovieDetail({required int? movieId});

  /// Returns a boolean indicating whether the movie detail with the given
  /// [movieId] is saved in the local data source.
